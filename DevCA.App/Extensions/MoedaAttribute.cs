...
namespace DevCA.App.Extensions
{
    ...
    public class MoedaAttributeAdapter : AttributeAdapterBase<MoedaAttribute>
    {
        ...
        public override void AddValidation(ClientModelValidationContext context)
        {
            ...
            MergeAttribute(context.Attributes, "data-val-numver", GetErrorMessage(context));
        }
    ...
    {
        private readonly IValidationAttributeAdapterProvider _baseProvader = new ValidationAttributeAdapterProvider();
        public IAttributeAdapter GetAttributeAdapter(ValidationAttribute attribute, IStringLocalizer stringLocalizer)
        {
            ...
            return _baseProvader.GetAttributeAdapter(attribute, stringLocalizer);
        }
    }
}
